...
async function searchDirectory(dir, pattern, matches) {
...
async function main() {
    ...
    server.tool("list_files", "List files in a directory within the project", { path: z.string().optional().default(".") }, async ({ path: relativePath }) => {
        try {
    ...
    server.tool("read_file", "Read contents of a file within the project", { path: z.string() }, async ({ path: relativePath }) => {
        try {
    ...
    server.tool("search_in_files", "Search for a text pattern in project files", { pattern: z.string(), directory: z.string().optional().default(".") }, async ({ pattern, directory }) => {
        try {
    ...
    server.tool("run_command", "Run a whitelisted command in the project", { command: z.string() }, async ({ command }) => {
        try {
